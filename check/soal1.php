					...
					<div class="row justify-content-between align-items-center pb-120 appointment-wrap">
						...
						<div class="col-lg-6 col-md-6 appointment-right pt-60 pb-60">
							<form class="form-wrap" action="proses-edit-kar.php" method="post">
								<h3 class="pb-20 text-center mb-30">Pertanyaan 1</h3>	
									...
									<br>
									<br>
										<li>Kesulitan bernafas yang parah (Bernafas dengan sangat cepat atau berbicara dalam satu kata)
										</li>
								...
								<a href="jawaban1.php" class="genric-btn danger circle">YA</a>
								<a href="soal2.php" class="genric-btn info circle arrow">TIDAK<span class="lnr lnr-arrow-right"></span></a>
							</form>
