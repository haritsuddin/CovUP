					...
					<div class="row justify-content-between align-items-center pb-120 appointment-wrap">
						...
						<div class="col-lg-6 col-md-6 appointment-right pt-60 pb-60">
							<form class="form-wrap" action="proses-edit-kar.php" method="post">
								<h3 class="pb-20 text-center mb-30">Pertanyaan 3</h3>	
								...
								<a href="soal4.php" class="genric-btn danger circle">YA</a>
								<a href="soal4.php" class="genric-btn info circle arrow">TIDAK<span class="lnr lnr-arrow-right"></span></a>
							</form>
